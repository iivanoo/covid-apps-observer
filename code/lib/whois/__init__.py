...
def query(domain, force=1, cache_file=None, slow_down=0, ignore_returncode=0):
    """
    ...
    while 1:
        query_result = do_query(d, force, cache_file, slow_down, ignore_returncode)
        pd = do_parse(query_result, tld)
