...
| **Last update** | 2021-02-24 16:42:40 |
| **Recent changes** | Thank you for using Smittestop. In this version the user interface has been improved to make it easier to report yourself infected. |
| **Installs**  | 500,000+ |
| **Category** | Medical |
...
The Smittestop app has been installed by more than **500000** times. At this time, **2165** rated the app and its average score is **2.8475337**. Below we show the distribution of the ratings across the usual star-based rating of Google Play

:star::star::star::star::star:: 583

:star::star::star::star:: 262
