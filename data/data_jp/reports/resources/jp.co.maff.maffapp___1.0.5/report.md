...
| **Last update** | 2020-12-22 10:55:02 |
| **Recent changes** | ・ドラムロールUIの変更(マフちょくのテーマ入力フォーム)<br>・パスワード禁止文字追加(全角文字) |
| **Installs**  | 5,000+ |
...
The MAFFアプリ app has been installed by more than **5000** times. At this time, **22** rated the app and its average score is **3.2272727**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
