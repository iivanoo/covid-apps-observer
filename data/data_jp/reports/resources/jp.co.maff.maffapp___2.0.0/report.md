...
| **Last update** | 2021-03-24 03:18:49 |
| **Recent changes** | 〇ホームページ<br>・熱中症警戒アラート発令の通知<br>・新着情報に記事一覧へ移動するボタンの追加<br>・閲覧数ランキング数の件数変更（5件⇒10件）<br><br>〇情報ページ<br>・情報ページのデザイン変更<br>・記事一覧のデザイン変更<br>・関心事項に「お知らせ」を追加<br>・絞り込み検索条件の変更<br><br>〇マフすぐページ<br>・マフすぐページのデザイン変更<br><br>〇プロフィール登録、更新画面<br>・「関心のある作目」、「関心事項」に「全て選択・選択解除」ボタンの追加 |
| **Installs**  | 10,000+ |
