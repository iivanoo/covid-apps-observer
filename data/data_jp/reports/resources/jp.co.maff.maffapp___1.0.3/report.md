...
| **Last update** | 2020-06-15 16:15:18 |
| **Recent changes** | ・プロフィール画面のユーザ区分を「農業者」で選択した際に表示される項目に、「主な作目」の選択欄及び経営規模入力欄を追加<br>・イベント記事の地図上に「地図アプリで見る」ボタンを追加 |
| **Installs**  | 5,000+ |
...
The MAFFアプリ app has been installed by more than **5000** times. At this time, **14** rated the app and its average score is **3.4285715**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
