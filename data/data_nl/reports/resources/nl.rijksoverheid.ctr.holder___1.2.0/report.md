...
| **Last update** | 2021-05-01 08:25:47 |
| **Recent changes** | - Het is nu ook mogelijk om via een externe link de app te openen en een QR-code te maken indien de testaanbieder deze link aanbiedt<br>- Enkele schermen zijn verbeterd<br>- Diverse verbeteringen op het gebied van toegankelijkheid<br>- Diverse bugs zijn opgelost |
| **Installs**  | 50.000+ |
| **Category** | Tools |
...
The CoronaCheck app has been installed by more than **50000** times. At this time, **72** rated the app and its average score is **2.9583333**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
