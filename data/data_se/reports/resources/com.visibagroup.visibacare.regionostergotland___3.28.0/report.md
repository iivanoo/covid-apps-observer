...
| **Last update** | 2020-12-03 09:15:34 |
| **Recent changes** | - |
| **Installs**  | 5,000+ |
| **Category** | Medical |
...
The Din Vård Region Östergötland app has been installed by more than **5000** times. At this time, **100** rated the app and its average score is **4.36**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
