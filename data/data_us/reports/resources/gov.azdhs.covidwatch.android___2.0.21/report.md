...
| **Last update** | 2021-01-08 10:36:40 |
| **Recent changes** | We have been busy making improvements and have a lot of exciting things to share! Here’s what’s new:<br>  • Fully redesigned app navigation based on feedback from users like you<br>  • Enhanced exposure risk model and notification system<br>  • Detailed exposure information is back<br>  • Now you can get notified of exposures that are considered “low”<br>  • We now offer the option to anonymously opt-in to sharing very limited app stats that will help improve the app for everyone. |
| **Installs**  | 5,000+ |
| **Category** | Medical |
...
> - This application opens a Socket and connects it to the remote address 'Ln/a/a/a/a;->o(Ljava/lang/String;)Ljava/lang/StringBuilder;' on the 'N/A' port <br>
...
The Covid Watch Arizona app has been installed by more than **5000** times. At this time, **39** rated the app and its average score is **3.8205128**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
...
> Since Jan 2021 update (dated December 30, 2020) there's a non-dismissable notification saying "Checking for possible exposures to COVID-19"<br> :date: __2021-01-13 02:49:17__
...
> I have the app installed but my region of Arizona isn't listed. The statewide reporting isn't up and running so I can't choose that as a region. I guess I am left out in the heat on this one. I will update to higher stars once the reporting becomes available in places besides two university regions.<br> :date: __2020-12-09 00:50:40__
