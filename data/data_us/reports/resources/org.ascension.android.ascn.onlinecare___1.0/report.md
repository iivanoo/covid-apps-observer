...
| **Latest version** | 1.0 |
| **Last update** | 2021-01-26 19:12:51 |
| **Recent changes** | We are continuing to improve your experience with these new features:<br>  - New design to make it easier to find the care that’s right for you<br>  - Easier enrollment to get the care you need, faster<br>  - Enhanced experience to make the entire visit quicker and more convenient – from intake to pharmacy search<br>  - General bug fixes and improvements |
| **Installs**  | 50,000+ |
| **Category** | Medical |
...
The Ascension Online Care – See a Doctor 24/7 app has been installed by more than **50000** times. At this time, **1235** rated the app and its average score is **4.384**. Below we show the distribution of the ratings across the usual star-based rating of Google Play

:star::star::star::star::star:: 940
