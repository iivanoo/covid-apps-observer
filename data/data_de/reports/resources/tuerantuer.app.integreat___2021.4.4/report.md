...
| **Latest version** | 2021.4.4 |
| **Last update** | 2021-05-06 05:05:20 |
| **Recent changes** | Wir haben hinter den Kulissen hart gearbeitet, um sicherzustellen, dass alles so funktioniert, wie es soll. Wenn Sie bemerken, dass etwas nicht funktioniert, lassen Sie es uns wissen!<br>* Wir zeigen jetzt eine Fehlermeldung an wenn das Wechseln zu einer neuen Sprache fehlschlägt.<br>* Du hast nun die Möglichkeit deine E-Mail Adresse beim Senden von Feedback zu hinterlassen. |
| **Installs**  | 10.000+ |
...
The Integreat app has been installed by more than **10000** times. At this time, **153** rated the app and its average score is **4.44**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
