...
| **Last update** | 2020-11-25 16:09:17 |
| **Recent changes** | - Neue Link zu &quot;Häufig gestellte Fragen&quot; unter &quot;Corona&quot; -&gt; &quot;weitere Informationen&quot;<br>- Fehler beim App-Start auf einigen Android-Geräten abgefangen<br>- Absturz an einer Stelle in der Navigation behoben (Corona-Tab)<br>- Fehler behoben bei &quot;aktuelle Maßnahmen&quot; im Corona-Tab<br>- optische Anpassungen bei den Corona-Diagrammen<br>- kleinere Fehlerbehebungen<br><br>Weitere Verbesserungen und Fehlerbehebungen kommen mit den folgenden Updates. |
| **Installs**  | 1.000+ |
...
The Mensch, Solingen app has been installed by more than **1000** times. At this time, **44** rated the app and its average score is **2.7954545**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
...
> Hallo, wenn das letzte Update das Problem einer möglichen Server Verbindung lösen sollte, ist das nicht gelungen. Es ist immer nur eine Verbindung nach der Neuinstallation möglich.<br> :date: __2020-11-26 08:59:53__
...
> Ständig habe ich Probleme die App zu öffnen. S 20 plus. Heute neuer Update und funktioniert immer noch nicht. Schade! Erst hat es heute funktioniert, aber heute Abend leider nicht.😔 Heute funktionierte es auch nicht. Ich werde es löschen.<br> :date: __2020-11-29 16:43:15__

> App funktioniert nicht. Vor 10 Tagen runtergeladen - es erscheint, dass ich mit dem Server verbunden bin, dann sehe ich die Startseite - aber dann geht nix mehr - der kleine Pfeil nacht rechts scheint ohne Funktion, wie die Pkt. unten auch. Seit dem gabs 2 oder 3 Updates inkl. dem letzten am 26.11. aber keine Änderung - damit bleibt die App zunächst für mich sinnlos.......Schade.<br> :date: __2020-11-28 08:53:45__

> Installiert und läuft nicht. Keine Meldung oder Reaktion, nur der gelber Kreis Mensch Solingen. Hab den Schrott wieder gelöscht, 1 Stern ist schon zuviel.<br> :date: __2020-11-22 12:52:30__

> Nach ein paar Wochen startet die App nicht mehr. Eigentlich eine schöne App...<br> :date: __2020-11-21 08:20:55__

> Leider lässt sich die App nach der Erweiterung nicht mehr öffnen. Es geht nur einmalig nach Hochfahren des Smartphones, dann kein Kontakt mehr zum Server.<br> :date: __2020-11-20 15:08:41__

> Seit dem letzten Update nicht mehr zu gebrauchen.<br> :date: __2020-11-19 23:19:30__

> Nach der Installation und dem 1. Öffnen eine gute App. Leider kein 2. Öffnen möglich. ??? Samsung A50.<br> :date: __2020-11-19 17:52:38__

> Stürzt schon beim ersten Ausprobieren ab und passt sich nicht an die Displaygröße meines Moto G5 an, bei den Startinformationen ist Text unten nicht lesbar und es kann auch nicht dahin gescrollt werden.<br> :date: __2020-11-19 17:24:22__

> Wozu muss ich meinen Standort freischalten um Informationen zu erhalten???<br> :date: __2020-10-24 23:25:13__

> App bleibt hängen...<br> :date: __2020-08-24 09:40:56__
