...
| **Latest version** | 2021.3.4 |
| **Last update** | 2021-03-20 16:23:47 |
| **Recent changes** | Wir haben hinter den Kulissen hart gearbeitet, um sicherzustellen, dass alles so funktioniert, wie es soll. Wenn Sie bemerken, dass etwas nicht funktioniert, lassen Sie es uns wissen!<br>* Es können nun einzelne Nachrichten geteilt werden.<br>* Links können nun direkt mit der App geöffnet werden. |
| **Installs**  | 10.000+ |
...
The Integreat app has been installed by more than **10000** times. At this time, **145** rated the app and its average score is **4.42**. Below we show the distribution of the ratings across the usual star-based rating of Google Play

:star::star::star::star::star:: 120
