...
| **Last update** | 2020-11-25 15:55:40 |
| **Recent changes** | Wir haben hinter den Kulissen hart gearbeitet, um sicherzustellen, dass alles so funktioniert, wie es soll. Wenn Sie bemerken, dass etwas nicht funktioniert, lassen Sie es uns wissen!<br>* Der Inhalt wird nun während des Updatens der Inhalte weiterhin angezeigt.<br>* Verbesserte Darstellung von Inhalten auf zweiter und dritter Ebene in den Kategorieauflistungen.<br>* Abstürzen der App wurde behoben. Wir entschuldigen uns für entstandene Probleme!<br>* Bug beim Sprachwechsel behoben. |
| **Installs**  | 10.000+ |
...
The Integreat app has been installed by more than **10000** times. At this time, **142** rated the app and its average score is **4.45**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
