...
| **Latest version** | 2021.6.3 |
| **Last update** | 2021-07-01 05:03:53 |
| **Recent changes** | Wir haben hinter den Kulissen hart gearbeitet, um sicherzustellen, dass alles so funktioniert, wie es soll. Wenn Sie bemerken, dass etwas nicht funktioniert, lassen Sie es uns wissen!<br>* Behebt das Verwschinden von Bildern wenn das Gerät gedreht wird. |
| **Installs**  | 10.000+ |
...
The Integreat app has been installed by more than **10000** times. At this time, **155** rated the app and its average score is **4.41**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
