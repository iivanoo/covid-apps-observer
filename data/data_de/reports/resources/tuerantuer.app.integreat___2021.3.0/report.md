...
| **Latest version** | 2021.3.0 |
| **Last update** | 2021-03-01 06:25:47 |
| **Recent changes** | Wir haben hinter den Kulissen hart gearbeitet, um sicherzustellen, dass alles so funktioniert, wie es soll. Wenn Sie bemerken, dass etwas nicht funktioniert, lassen Sie es uns wissen!<br>* Die URL zum Teilen von Inhalten wird nach dem Ändern der Sprache nun korrekt gesetzt.<br>* Links in lokalen Nachrichten können nun durch Anklicken direkt geöffnet werden. |
| **Installs**  | 10.000+ |
