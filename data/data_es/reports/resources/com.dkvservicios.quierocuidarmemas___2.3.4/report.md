...
| **Last update** | 2021-05-25 09:12:05 |
| **Recent changes** | En esta nueva versión de Quiero cuidarme Más traemos diversas novedades: Ahora la solicitud de receta electrónica se incluye en el apartado “Mi farmacia”, desde el que también podrás tener un chat con un farmacéutico e incluso revisar diferentes ofertas de productos relacionados. Desde la sección de “Cuida tu mente”, además de información sobre servicios relacionados de DKV Club Salud y Bienestar. Actualizado el formato de la Medicard virtual. |
| **Installs**  | 100.000+ |
...
The DKV Quiero cuidarme Más: tu salud y médicos online app has been installed by more than **100000** times. At this time, **706** rated the app and its average score is **3.81**. Below we show the distribution of the ratings across the usual star-based rating of Google Play

:star::star::star::star::star:: 396
