...
| **Last update** | 2021-02-10 12:50:18 |
| **Recent changes** | [GL]<br>— Opción de utilización de PassCOVID en inglés.<br>— Melloras diversas e corrección de erros.<br>[ES]<br>— Opción de utilización de PassCOVID en inglés.<br>— Mejoras diversas y corrección de errores. |
| **Installs**  | 50.000+ |
...
The PassCOVID.gal app has been installed by more than **50000** times. At this time, **131** rated the app and its average score is **3.1089108**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
