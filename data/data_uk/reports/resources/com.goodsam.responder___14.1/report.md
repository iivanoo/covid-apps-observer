...
| **Recent changes** | - Fixing a bug which was causing the app to crash on the task screen without the location services permission. |
| **Installs**  | 100,000+ |
...
The GoodSAM Responder app has been installed by more than **100000** times. At this time, **1355** rated the app and its average score is **2.8235295**. Below we show the distribution of the ratings across the usual star-based rating of Google Play

:star::star::star::star::star:: 329
