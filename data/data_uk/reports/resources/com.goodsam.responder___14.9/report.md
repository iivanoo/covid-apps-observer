...
| **Latest version** | 14.9 |
| **Last update** | 2021-06-21 17:41:52 |
| **Recent changes** | This update has new features for our Police and emergency service users:<br>- Ability for advanced users to send video invites directly and get notified when they are opened (for example for missing people).<br>- Ability to see all live invites and all captured evidence and search for them (through 2 new additionally tabs).<br>- Ability to send consultation invites and choose whether or not to record the consultation.<br>- Ability to upload one or multiple images/videos directly to GoodSAM. |
| **Installs**  | 100,000+ |
...
The GoodSAM Responder app has been installed by more than **100000** times. At this time, **1388** rated the app and its average score is **3.1285715**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
...
> Useless App does not work<br> :date: __2021-06-26 21:51:58__
