...
The COVID Control - A Johns Hopkins University Study app has been installed by more than **500** times. At this time, **8** rated the app and its average score is **4.125**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
