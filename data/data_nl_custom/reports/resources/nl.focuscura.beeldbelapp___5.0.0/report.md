...
| **Last update** | 2020-12-01 10:36:25 |
| **Recent changes** | In deze update is videobellen verbeterd voor ziekenhuizen. We zijn gestopt met de ondersteuning van cContact in de thuiszorg. |
| **Installs**  | 100.000+ |
| **Category** | Medisch |
...
> - This application opens a Socket and connects it to the remote address 'Lb/d/b/a/a;->M(Ljava/lang/String;)Ljava/lang/StringBuilder;' on the 'N/A' port <br>
...
The Luscii app has been installed by more than **100000** times. At this time, **7734** rated the app and its average score is **4.319176**. Below we show the distribution of the ratings across the usual star-based rating of Google Play

:star::star::star::star::star:: 4321

:star::star::star::star:: 2409
