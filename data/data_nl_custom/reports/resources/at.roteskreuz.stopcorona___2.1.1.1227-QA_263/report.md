...
| **Recent changes** | We´re keeping it up to date for you:<br><br>- changes to the homescreen - you can now see activities of the app (most recent updates and risk contacts)<br>- report as healthy (end quarantine after infection is over)<br>- warn your contacts via the menu<br>- possibility to set a date for the symptom onset<br>- minor bug fixes<br><br>Let´s continue to Stopp Corona together! |
| **Installs**  | 100.000+ |
| **Category** | Medisch |
