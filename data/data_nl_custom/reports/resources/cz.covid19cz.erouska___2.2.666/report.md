...
| **Latest version** | 2.2.666 |
| **Last update** | 2020-11-11 10:46:44 |
| **Recent changes** | New main screen, numbers about eRouška in News, search in Help, bugfixes. |
| **Installs**  | 1.000.000+ |
...
The eRouška - Part of Smart Quarantine app has been installed by more than **1000000** times. At this time, **6616** rated the app and its average score is **3.6580732**. Below we show the distribution of the ratings across the usual star-based rating of Google Play

:star::star::star::star::star:: 3358

:star::star::star::star:: 907
