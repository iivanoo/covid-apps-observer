...
> Удобно<br> :date: __2021-04-18 08:50:16__

> Мне нравится, хорошее приложение. Запись через чат к врачу это странно, но работает.<br> :date: __2021-04-14 16:57:46__

> Мне приложение понравилось. Доступ к дневнику + дети в школе. Остальное можно и на компе потом сделать.<br> :date: __2021-04-14 10:36:40__

> Хорошее удобное для своих функций приложение. Постоянно расширяется функционал и улучшается качество. Молодцы.<br> :date: __2021-04-14 06:58:18__

> Удобное приложение!<br> :date: __2021-04-13 16:25:17__

> Очень удобно. Можно не выходя из дома записаться к врачу. Правда, надо делать всё это заранее. Ведь очередь может достигать 2 и больше недель. Хороший вариант для относительно здоровых людей. Кому требуется неотложная медицинская помощь, такой вариант не подойдет.<br> :date: __2021-04-13 16:05:40__

> Плохо, что снимают за переводы при оплате счетов за детский сад 😢<br> :date: __2021-04-12 22:49:34__
...
> С последним обновленем приложение перестало загружаться от слова совсем. Разрабы, исправьте косяк!<br> :date: __2021-04-18 02:05:54__

> Товарищ Ликсутов, и мистер Собянин, вы ещё не наелиль чёрной икры??! Как так можно, чтобы при з/п 45000 и коммуналке 8000, а также кредите 12000, вы выставили своими фотоштрафами за пару дней 10000 руб!?! Чем я должна кормить своего ребёнка??? Абсолютно уверенна, Господь всё знает и видит!!! А если и Бога не боитесь, то вспомните уроки истории - русский долго терпит, но уж если ресьбу сорвёт, то мало не будет! В аэропорт не успеете добежать!<br> :date: __2021-04-16 17:03:11__

> Ужас какой-то! К врачу не записаться!<br> :date: __2021-04-15 22:50:56__

> Не удаляются старые записи к врвчу!<br> :date: __2021-04-14 11:35:25__

> Ужасное приложение! Разработчики, а вы читаете отзывы? Один негатив. Разработка ПО - это не ваше (хотя для отмывания денег пойдет). Раздел Медицина: записаться к врачу невозможно - запись отсутствует, хотя в поликлинике на терминале запись доступна. Вот и приходится мотаться больным людям в поликлинику для записи на прием. А это очень полезно для организма в период пандемии.<br> :date: __2021-04-13 07:24:56__

> "Что-то пошла не так, попробуйте позже" - выдаёт система при попытке отправить обращении в ращделе Помощь! А обращение пыталась отправить, так как запись к врачу выдавала "Ошибку". В итоге записаться не смогла ещё и отправить обращение относительно этой проблемы не смогла! Как итог - ничего не работает, приложение БЕСПОЛЕЗНОЕ!<br> :date: __2021-04-13 07:12:11__
