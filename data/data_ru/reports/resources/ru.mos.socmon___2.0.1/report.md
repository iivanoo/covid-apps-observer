...
> 30.06.2021 - геолокация не отправляется. Выдает ошибку, что геопозиция не была отправлена, попробуйте позже. Пробовала раз 10 уже. Хотя, саму локацию определяет правильно. И до сегодняшнего дня все работало корректно. Время на идентификацию истекает. Вопрос разработчикам: что делать?<br> :date: __2021-06-30 13:13:03__
...
> Тупейшая реализация фашистского приложения! Мало того, что глюсит и аккум выносит, так еще и штраф прислало, который никто найти не может и объяснить за что.<br> :date: __2021-07-04 16:36:02__

> Приложение не работает, переустановка проблему не решила.<br> :date: __2021-07-04 16:26:10__

> Это программа не работает , заканчивайте разводить людей на деньги<br> :date: __2021-07-04 16:11:16__

> оштрафовали за то что у них в приложении был сбой и я не мог отправить геолокацию. это враги народа а не люди. говорят обратитесь в тех. поддержку. дозванивался 40 минут результата ноль. говорят идите в суд.<br> :date: __2021-07-04 16:07:57__

> одна звезда авансом, номер пока на проверке<br> :date: __2021-07-04 16:02:42__

> не возможно установить приложение, не скачивается<br> :date: __2021-07-04 15:30:05__

> Виснет даже не пройдя регистрации. Все разрешения дал, а прога глючит и зависает весь телефон. Разве нельзя что то получше сочинить (((. Для отслеживания граждан или только штрафовать умеем. Короче дозвониться несмог, зарегистрироваться тоже. Это след для обжалования штрафа, если вдруг оштрафуют не из-за моей вины. Вообще могли бы и установливать приложение при выдаче бумаженки о самоизоляции.<br> :date: __2021-07-04 14:59:17__

> Вы твари. Животными вас назвать, язык не поворачивается. Мысль о том, что вы существуете на наши налоги, уничтожает веру в государство. Мы болеем, а нас ещё штрафами пытаются пугать. Никакой поддержки, бизнес загибается. На людей, потерявших работу, плевать. И теперь ещё эти бесконечные сообщения в приложении. Вы уроды.<br> :date: __2021-07-04 14:49:24__

> Фашизм<br> :date: __2021-07-04 14:33:04__

> В тех поддержку не дозвониться, сервис глючит<br> :date: __2021-07-04 14:32:02__
