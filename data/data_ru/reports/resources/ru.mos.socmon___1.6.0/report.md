...
> Установила приложение, несколько недель уже на подтверждении данных....(пробовала переустанавливать) связано ли это с тем, что я не заражена, мне только нужна информация о других людях, которые поблизости?<br> :date: __2020-07-25 21:18:27__
...
> Отвратительно.<br> :date: __2020-07-28 10:33:51__

> не работает<br> :date: __2020-07-28 06:40:41__

> Это жесть, господа, батарею жрет как не в себя, убийственная приложуха. Хотите уничтожить телефон? Рекомендую.<br> :date: __2020-07-28 00:09:46__

> Развод людей и отмывание денег с помощью создания приложения и тех. поддержки. Не работает и не будет работать, вероятно. На первые сутки отсутствия ответа от приложения техподдержка говорила, что 1 сутки обработки номера телефона - это ок. Когда прошли сутки, звоню, говорю, ответ такой :"а до трех суток это нормально". Звоню на третьи сутки-" 4 дня может обрабатывать". Потом заявку оформили. Идиотизм. Номер телефона совпадает в постановлении, да! Хватит скрипты слать. Всё как всегда.<br> :date: __2020-07-27 20:03:31__

> Отвратительно приложение,полностью убивает телефон.<br> :date: __2020-07-27 18:55:21__

> Не работает на устройствах с root доступом. И что теперь делать? Убирать root, это прикол?<br> :date: __2020-07-27 18:45:01__

> Установила приложение 22.07.2020 года, в день получения постановления. Ежедневно по несколько раз захожу в приложение и вижу " Номер находится на подтверждении". Т.к. из департамента здравоохранения мне звонят и интересуются самочувствием, могу сделать вывод, что номер в постановлении врачом указан верно. Звонила на горячую линию уже дважды 24.07 и 27.07, оба раза ответ один - ждите. Если штрафов, то это однозначно будет судебное разбирательство из-за Вашего НЕРАБОТАЮЩЕГО ПРИЛОЖЕНИЯ<br> :date: __2020-07-27 12:15:00__

> Скачала приложение См, более недели 3 раза в день делала фотографии и отправляла в приложении, но потом мне заблокировали номер телефона. После разблокировки, больше не могу зайти в СМ, так как приложение требует указать код, который никак не приходит на номер телефона. Звонила по номеру указанному в приложении несколько раз, и каждый раз то не отвечают, то отвечают, но советуют что то, что не помогает, то обещают соеденить с другим менеджером, а в итоге одни гудки.<br> :date: __2020-07-26 12:56:04__

> Не работает. Неделю номер был на проверке. Не дождался, удалил<br> :date: __2020-07-26 09:37:15__

> Издевательство, насильно впариваемое московской мэрией под угрозой штрафов. Угораздило заболеть? Спокойно поправляться вам не дадут. Поэтому, крепкого вам здоровья, дорогие сограждане. Не болейте!<br> :date: __2020-07-25 22:55:46__
