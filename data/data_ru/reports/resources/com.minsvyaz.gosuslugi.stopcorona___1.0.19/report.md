...
> Не открывается. Совсем как узнать тест? Тест открывается в гос.услугах по ссылке.<br> :date: __2021-01-23 01:19:45__

> Сканирую свой кю ар теста на ковид, а выходит надпись, что это не результат теста на ковид ((<br> :date: __2021-01-22 15:13:20__

> Бредовые приложение.<br> :date: __2021-01-22 14:16:38__

> Не работает Ваш сервис. Третий день сижу с подтвержденый диагнозом COVID-19, а приложение упорно пишет, что результаты теста не найдены.<br> :date: __2021-01-21 12:45:56__

> В анкете нет моего варианта ответа. Удалил сразу.<br> :date: __2021-01-21 10:29:29__

> Приложение не открывается нет интернета<br> :date: __2021-01-21 09:31:51__

> Нет результатов анализа на коронавирус. Сдавали через гос. поликлинику, кто тогда отправляет результаты в приложение? В общем то для чего скачивалась приложение, в нем нет<br> :date: __2021-01-21 02:34:15__

> Нет соединения пишет<br> :date: __2021-01-19 14:32:25__

> Установил приложение, чтобы посмотреть сертификат о прививке. Заполнил анкеты. Ничего похожего на сертификат о вакцинировании в приложении не нашел. Фактически вакцинирован. Приложение - бессмысленное и бесполезное г. Одна звезда приложению - чрезмерно щедрая оценка.<br> :date: __2021-01-18 13:17:00__

> Не показывает результаты тестов на коронавирус. Ни старых (июнь), ни свежего анализа крови (15.01.21). В личном кабинете ЕМИАС каким-то чудом результат появился - наверное, действительно ЕМИАС использует базу данных сдавших тест, а не говорит об этом. Опросник с личными данными заполнил, как теперь отозвать, администраторы?<br> :date: __2021-01-17 20:41:02__
