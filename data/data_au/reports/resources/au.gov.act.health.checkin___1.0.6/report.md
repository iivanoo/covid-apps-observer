...
| **Last update** | 2020-09-24 04:16:31 |
| **Recent changes** | Improved accessibility, bug fixes. |
| **Installs**  | 5,000+ |
...
The Check In CBR app has been installed by more than **5000** times. At this time, **29** rated the app and its average score is **3.9310346**. Below we show the distribution of the ratings across the usual star-based rating of Google Play
